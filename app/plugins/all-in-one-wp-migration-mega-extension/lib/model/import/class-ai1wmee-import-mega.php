...
class Ai1wmee_Import_Mega {

	public static function execute( $params, Ai1wmee_Mega_Client $mega = null ) {

		// Set progress
		Ai1wm_Status::info( __( 'Creating an empty archive...', AI1WMEE_PLUGIN_NAME ) );
		...
		// Get download URL
		$params['download_url'] = $mega->get_download_url( $params['node_id'] );

		// Set progress
		Ai1wm_Status::info( __( 'Done creating an empty archive.', AI1WMEE_PLUGIN_NAME ) );
